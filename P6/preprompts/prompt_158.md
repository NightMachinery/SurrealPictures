...
**Scatter:** Domino Tiles / Dice / Game Tokens & Iridescent Soap Bubbles & Tiny Doorways in Tilework
...
### 6. The Atmosphere
**Emotion:** Defiance (Rebellious Fire) & Vitality (Explosive Life)
...
### 8. The Stage
**Setting:** Celestial dry dock where comets are repaired
