...
**Archetype:** The Hermit & The Celebrant
...
**Logic Broken:** Sensory Synesthesia
...
### 6. The Stage
**Setting:** Rooftop festival quarter linked by kite bridges
...
**Angle:** Centered one-point perspective with aggressive depth lines
*Instruction: Lock the viewpoint. This is the viewer’s body position inside the scene.*

### 8. The Graphic Style (Time / Motion)
**Temporal Technique:** Sequential action beats arranged like storyboard panels
