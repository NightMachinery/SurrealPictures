...
**Archetype:** The Virgin & The Dreamer
...
**Logic Broken:** Musical Materialization
...
### 6. The Stage
**Setting:** Puppet opera avenue where marionettes cast human shadows
...
**Angle:** Bird's-eye diorama with tiny narrative clusters
*Instruction: Lock the viewpoint. This is the viewer’s body position inside the scene.*

### 8. The Graphic Style (Time / Motion)
**Temporal Technique:** Multiple exposure effect within one still
