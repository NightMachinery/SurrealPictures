...
The emotional register is adult in every dimension. The image should be capable of evoking longing, shame, ecstasy, grief, quiet dread, or tenderness depending on who is looking and what they bring to it. Treat the piece the way Klimt, Schiele, Mucha, and the great classical painters did: as a site of vulnerability, desire, power, and unresolved contradiction.
...
### 3. The Surreal Twist (Crucial)
**Logic Broken:** Gigantism
...
### 4. The Atmosphere
**Emotion:** Tenderness (Gentle Love)
*Instruction: Color grade and lighting should reflect this emotion. The mood must be palpable (not vague).*

### 5. The Symbols (Totems)
**Motifs:** Zahhak's Shoulder Serpents & The Stopped Clock
...
### 6. The Stage
**Setting:** Ice shelf labyrinth under polar halos
...
### 7. The Lens (Camera Angle)
**Angle:** Ultra-wide lens distortion with curving edges
*Instruction: Lock the viewpoint. This is the viewer’s body position inside the scene.*

### 8. The Lens (Composition / Framing)
**Framing:** Triptych-like internal partitioning in one frame
*Instruction: This is the composition logic. Enforce it: depth layers, occlusion, partitions, imbalance/symmetry—no compromises.*

### 9. The Graphic Style (Staging / Portraiture)
**Staging:** Hero centered while background tells counter-narrative
