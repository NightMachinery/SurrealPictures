...
- Seed fragments: Order safehouse memories colliding with school-day nostalgia | An owl-post ribbon wall of unsent apologies | A signet ring split then soldered in gold | Sensuality / Passion | Sky Replacement | A silver-green locket reflected in a puddle of potion water | Extreme low-angle portrait against monumental architecture | Scattered Pomegranate Seeds | Awe (Cosmic Scale)
