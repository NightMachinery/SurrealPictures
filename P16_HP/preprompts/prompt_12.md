...
- Seed fragments: An heirloom cane engraved with warding runes | Tiny Doorways in Tilework | Labyrinth / Complexity | A star map that redraws after each lie | Vitality (Explosive Life) | Corridor framing with repeated vanishing points | Anatomical Impossibility | A shared umbrella warded against ash and rain
