...
- Seed fragments: Old blood curses reframed as inherited trauma and ritual care | Pebble beach where portkeys wash ashore | A pumpkin feast table marked with empty memorial seats | Innocence / Purity | Behind-the-curtain vantage through translucent textiles | The Poison Antidote Brewer | Tea tins labeled with initials from different houses | Whimsy (Playful Absurdity)
