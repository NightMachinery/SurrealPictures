...
- Seed fragments: Edible Architecture | Wonder (Childlike Discovery) | House rivalry replaced by coalition politics in the school corridors | Tea tins labeled with initials from all four houses | Silence / Pause | Ultra-wide lens distortion with curving edges | Clock-hands harvested from broken time-turners
