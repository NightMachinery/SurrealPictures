...
- Seed fragments: A polyglot songbook shared by rival tables | A triangle-circle-line sigil scratched into candle wax | A werewolf support circle operating behind a reputable clinic | Graffiti initials hidden under fresh varnish on a classroom desk | Shelter / Home | Trunk room where charms keep letters from burning | The Betrothed Heirs in Political Truce | Defiance (Rebellious Fire)
