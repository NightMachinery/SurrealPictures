...
- Seed fragments: Material Transmutation | A bewitched map with moving ink footprints | Mountain keep containing a treaty-signing hall | Serenity (Deep Calm) | A polyglot songbook shared by rival tables | Dragon scale mail stitched into a school satchel | Corridor framing with repeated vanishing points | Dragon sanctuary workers smuggling eggs away from trophy collectors | Forgiveness / Grace
