...
- Seed fragments: Candles braided with friendship bracelets | Ledger books with names crossed out in emerald ink | Relief (Weight Lifted) | Inheritance / Legacy | Edible Architecture | A forbidden attempt to prevent a death by editing one memory at a time | Phoenix molted feathers stored in medicine jars
