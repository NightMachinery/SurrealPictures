...
- Seed fragments: Two versions of the same student silently coordinating across looping days | Mischief (Gleeful Trouble) | A star map that redraws after each lie | Ancient battlefield plain blooming with silver grass | Interwoven house scarves tied to one banquet chair | Duplication | Railway luggage tags from shifting platform numbers | Tenderness / Care
