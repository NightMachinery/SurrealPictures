...
- Seed fragments: Unspeakables cataloging forbidden prophecies that alter when observed | Castle corridors becoming memorial routes where portraits debate survivor guilt | A house banner stitched from old Quidditch uniforms | Silence / Pause | Hufflepuff kitchen annex stacked with shared care packages | The House-Elf Matriarch | Anatomical Impossibility | Defiance (Rebellious Fire) | A broken time-turner suspended in copper thread | Dutch angle with cascading diagonals
