...
- Seed fragments: Extreme low-angle portrait against monumental architecture | Mirrors with Missing Reflections | Clock-hands harvested from broken time-turners | Friendship / Bond | A cracked wand wrapped in elder wood splints | An eclipse medallion worn by two rival heirs | A dog tag, stag antler, and wolf medallion tied with one ribbon | Dream Logic | Portrait arranged as a theatrical reveal moment | Euphoria (Blinding Joy)
