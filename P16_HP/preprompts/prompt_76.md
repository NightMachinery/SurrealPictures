...
- Seed fragments: Ecstasy (Transcendent Bliss) | Moon-chart pins arranged around a cracked porcelain cup | Tenderness / Care | A ministry pass that changes department seal every hour | An unclaimed trunk tag from Platform Nine and Three-Quarters | Long-exposure light trails guiding the eye | Elevated balcony view through hanging foreground objects | An ancestral portrait frame standing empty | The Former Death Eater Defector | Soft Sculpture | Worm's-eye view with towering foreground ornament
