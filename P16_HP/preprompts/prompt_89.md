...
- Seed fragments: A spellbook margin annotated in three languages | Vintage tarot-card framing with crowded margins | The Astral Cartographer | Reopened Yule Ball hall with protective ward chandeliers | Tea tins labeled with initials from different houses | Awe (Cosmic Scale) | Humor / Laughter | Candles braided with friendship bracelets | An eclipse medallion worn by two rival heirs
