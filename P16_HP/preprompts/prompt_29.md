...
- Seed fragments: A broken time-turner suspended in copper thread | Time-lapse collage with repeated figure phases | Inheritance / Legacy | Black silk gloves dusted with silver potion residue | A spellbook margin annotated in three languages | Knight Bus maintenance yard under neon runes | Tenderness (Gentle Love)
