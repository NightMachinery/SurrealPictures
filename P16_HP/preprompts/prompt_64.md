...
**Objective:** Generate one high-fidelity text-to-image prompt for a custom adult gallery-grade *Dixit* card (vertical 2:3), with strong narrative coherence and surreal ambiguity.

## Seed Policy (Non-Negotiable)
...
- Target approximately **150-200 words**.
...
- Seed fragments: Masks on Hooks / Mask Fragments | Serenity (Deep Calm) | Resilience / Strength | Future letters delivered to past selves through bewitched archive drawers | The Centaur Prophecy Reader | A reconstructed house cup made from fused shards | A fable manuscript about three impossible brothers | Extreme low-angle portrait against monumental architecture | Eighth-year reconstruction turning rival dorms into forced peace experiments | Dream Logic | Abandoned school annex reclaimed as a refugee sanctuary
