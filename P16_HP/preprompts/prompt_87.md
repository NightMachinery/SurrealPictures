...
- Seed fragments: Candles braided with friendship bracelets | Generosity / Gift | Mischief (Gleeful Trouble) | Freeze-frame of motion blur trails | A fix-it timeline unraveling as each rescue causes a different loss | Merperson pearl strings hanging over maps | Teal curse-smoke trapped inside blown-glass phials | Toy Transmutation
