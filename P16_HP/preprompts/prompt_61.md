...
- Seed fragments: Cracked stained-glass house crests repaired with gold seams | Invisible Presence | Intimacy / Closeness | The Librarian of Restricted Shelves | Ecstasy (Transcendent Bliss) | Railway luggage tags from shifting platform numbers | Handprints / Palm Lines (Appearing on Surfaces) | A mirror shard that shows the wrong room
