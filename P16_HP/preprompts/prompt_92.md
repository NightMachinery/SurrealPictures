...
- Seed fragments: Serenity (Deep Calm) | Broom race tunnel carved through black stone | A pensieve vial labeled DO NOT EDIT | Hunger / Desire | An eclipse medallion worn by two rival heirs | Layer-cake depth: near clutter, mid action, far architecture | A magical university era where old school rivalries harden into ideology | A fix-it timeline unraveling as each rescue causes a different loss | The Portrait Headmistress Who Never Sleeps
