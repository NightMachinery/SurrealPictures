...
- Seed fragments: Mosaic patchwork segmentation across the whole frame | Joint detention ledgers stamped PAID IN FULL | Inheritance / Legacy | Phoenix ash mixed into healing salve | Leather & Amber | Phoenix molted feathers stored in medicine jars | Euphoria (Blinding Joy) | Ledger books with names crossed out in emerald ink
