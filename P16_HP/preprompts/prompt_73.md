...
- Seed fragments: A werewolf support circle operating behind a reputable clinic | Gratitude / Thanksgiving | A cracked omniocular replaying the same duel | Pride (Earned Glory) | A time-slip where modern students overhear unfinished Marauders arguments | Centered one-point perspective with aggressive depth lines
