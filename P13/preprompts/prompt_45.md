...
- Seed fragments: The Aurora Borealis | The Skull | Profile portrait split by architectural axis | The Widow | A fire demon in a hearth | Sky Replacement | Persian Tilework & Lapis Lazuli | Lantern festival as memory-triggering revelation | Centered one-point perspective with aggressive depth lines | Tide clock lighthouse with living interior walls | Relief (Weight Lifted) | Entropy | Time-lapse collage with repeated figure phases | The Lighthouse
