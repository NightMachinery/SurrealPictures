...
- Seed fragments: Diptych logic fused into one card | Calligraphy & Saffron | Yellow scream canisters | Edible Architecture | Mischief (Gleeful Trouble) | The Scientist | The Lightning-Struck Tree | Button-eyed duplicate family using affection as trap | The Music Box | Pearl reef amphitheater beneath shallow moonlight | Abandonment / Desolation
