...
- Seed fragments: Intimacy (Quiet Closeness) | The Open Hand | Memory / Nostalgia | Wonder (Childlike Discovery) | Wand sparks | The Caduceus | Centered one-point perspective with aggressive depth lines | Hands-in-foreground storytelling with distant figure | Midnight deadline tension with vanishing glamour
