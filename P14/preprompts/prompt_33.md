...
- Seed fragments: Puppet opera avenue where marionettes cast human shadows | Whimsy (Playful Absurdity) | The Half-Burned Candle | Soft Sculpture | Ageing recluse mentoring eager wilderness novice | Inheritance / Legacy | The Masquerade Mask | A wooden hand with joint pins | Extreme low-angle portrait against monumental architecture
